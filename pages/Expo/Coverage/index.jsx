...
const Coverage = () => {
  return (
    <Layout>
      <div className="h-screen bg-fixed  bg-cover imgBgExpo_2 relative pt-10">
        <div className="container text-center lg:text-left text-white text-lg sm:text-xl md:text-2xl lg:text-3xl px-10">
          ...
          <p className="pt-10 lg:absolute lg:top-64 lg:right-1 lg:w-[500px]">
            xcien currently has offices in 11 states in the country, located in
            the 3 main economic regions, for nationwide coverage.
          </p>
