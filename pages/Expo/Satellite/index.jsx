...
const Satellite = () => {
  return (
    <>
      <Layout>
        <div className="lg:h-screen  bg-center bg-cover imgBgExpo_10 pt-10">
          <div className="container mx-auto text-center lg:text-left text-white text-lg sm:text-xl md:text-2xl lg:text-3xl px-10">
            ...
            <p className="pt-14 ">
              ...
              require a fast response such as point-of-sale terminals, voice
              over IP, closed circuit systems, alarms or streaming.
            </p>
          ...
          <div className="h-screen bg-fixed bg-center bg-cover imgBgExpo_11 relative">
            <div className="container mx-auto text-center lg:text-left text-white text-lg sm:text-xl md:text-2xl lg:text-3xl px-10">
              ...
              <div className="lg:absolute">
                <div className="grid grid-cols-2 place-items-center lg:flex justify-center gap-10 lg:gap-36 pt-10">
                  <div>
                  ...
                  <div className="translate-x-20 sm:translate-x-40 lg:translate-x-0">
                    <Image src={Pharmacy} alt="Pharmacy" className="w-24" />
                    <p className="text-white text-sm lg:text-lg">Pharmacies</p>
                  </div>
                </div>
                <div className="grid grid-cols-2 place-items-center lg:flex justify-center gap-36 pt-28">
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm lg:text-lg">Warehouses</p>
                  </div>
                </div>
              </div>

              <div className="lg:absolute bottom-0 lg:bottom-36 right-0">
                <Image src={Starlink} className="w-[500px]" alt="Starlink" />
              </div>
              <div className="lg:absolute bottom-5 right-[30%]">
                <p>
                  State-of-the-art
                  <br />
        ...
        <>
          <div className="lg:h-screen py-20 bg-fixed bg-center bg-cover imgBgExpo_3">
