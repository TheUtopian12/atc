  ...
  return (
    <>
      ...
      <section className="bg-[url('/assets/img/Backgrounds/videovigilancia_low.jpg')] bg-cover h-[100vh]  relative">
        ...
        <section className="flex justify-center items-center pt-64 gap-2 ">
          <Image
            ...
            className="w-[500px] "
          />
          <ImArrowRight size={200} color="orange" />
          <Image
      ...
      <section className="bg-[url('/assets/img/Backgrounds/cableado_estructurado_low.jpg')] bg-cover h-[100vh]  relative">
